  ...
  if (isObjectType || isInterfaceType || isUnionType) {
    ...
    if (typeExtensions.length) {
      typeExtensionDefinitionMap[typeName] = typeExtensions.map(function (extension) {
        ...
        var isObjectExtension = extension.kind === _graphql.Kind.OBJECT_TYPE_EXTENSION;
        var isInterfaceExtension = extension.kind === _graphql.Kind.INTERFACE_TYPE_EXTENSION;
        ...
        if (isObjectExtension || isInterfaceExtension) {
          ...
          var _augmentNodeTypeField2 = (0, _slicedToArray2["default"])(_augmentNodeTypeField, 4);
